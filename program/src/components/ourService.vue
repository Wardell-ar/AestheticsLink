        ...
        <div class="services-grid">
            <div class="service-item" v-for="(service, index) in services" :key="index">
                ...
                <div class="service-description">
                    ...
                    <p class="service-text">价格: {{ service.price }} ￥</p>
                </div>
...
<script>
import { getHospitalNameReq, getSurgeryPrice, getAllCoupons, setOrder } from "../HTTP/http"
...
export default {
    ...
    mounted(){
        getSurgeryPrice(this.setPrice);
    },
    methods: {
        setPrice(res){
            this.services[0].price = res[0];
            this.services[1].price = res[1];
            this.services[2].price = res[2];
            this.services[3].price = res[3];
            this.services[4].price = res[4];
            this.services[5].price = res[5];
        },
