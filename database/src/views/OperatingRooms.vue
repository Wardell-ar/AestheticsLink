...
export default {
  data() {
    return {
      ...
      // ],
      operatingRooms: [
        { roomId: '1', slots: [{ status: '0', info: '无预约',doctor:"xiaoming",customer:"11" }, { status: '1', info: '手术 A',doctor:"xiaoming",customer:"11" }, { status: '0', info: '无预约' ,doctor:"xiaoming",customer:"11"}, { status: '1', info: '手术 B' ,doctor:"xiaoming",customer:"11"}] },
        { roomId: '2', slots: [{ status: '1', info: '手术 E',doctor:"xiaoming",customer:"11" }, { status: '1', info: '手术 C' ,doctor:"xiaoming",customer:"11"}, { status: '0', info: '无预约',doctor:"xiaoming",customer:"11" }, { status: '1', info: '手术 D' ,doctor:"xiaoming",customer:"11"}] },
        { roomId: '3', slots: [{ status: '1', info: '手术 E' ,doctor:"xiaoming",customer:"11"}, { status: '0', info: '无预约' ,doctor:"xiaoming",customer:"11"}, { status: '1', info: '手术 F' ,doctor:"xiaoming",customer:"11"}, { status: '0', info: '无预约' ,doctor:"xiaoming",customer:"11"}] },
        { roomId: '4', slots: [{ status: '0', info: '无预约' ,doctor:"xiaoming",customer:"11"}, { status: '0', info: '无预约',doctor:"xiaoming",customer:"11" }, { status: '1', info: '手术 G' ,doctor:"xiaoming",customer:"11"}, { status: '1', info: '手术 H' ,doctor:"xiaoming",customer:"11"}] }
      ]
    };
  },
  methods: {
